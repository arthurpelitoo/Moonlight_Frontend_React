...
import { useUserCreatorForm } from "../../../../hooks/validation/Admin/useUserCreatorForm";
...
export function UserCreatorForm(){
    const {fields, selectOptions, setField, setCpf, showErrors, toggleShowConfirm, toggleShowPassword, ui, handleBlur, handleSubmit} = useUserCreatorForm();
    ...
    return (
        <div className="flex flex-col gap-3 w-full">
            ...
            >
                {ui.loading ? <LoadingDots /> : <>Criar Usuario <ArrowRightIcon size={16} weight="bold" /></>}
            </Button>
        </div>
    )
}