            ...
            {!confirmLogout
                ?(
                    <div>
                        ...
                        {isAdmin &&
                            <Button as="link" variant="primary" href="/admin" className={`max-lg:active:bg-white max-lg:active:text-base lg:hover:bg-white lg:hover:text-base transition-all duration-300 w-full block px-4 py-2 text-sm`}>Administrativo</Button>
                        }
