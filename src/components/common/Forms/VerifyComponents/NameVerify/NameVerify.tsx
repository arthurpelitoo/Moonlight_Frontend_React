import { getNameVerifiedLevel } from "../../../../../utils/Validation/dataRules/name";


type NameVerifyProps = {
    name: string;
    showError: boolean
}
...
export function NameVerify({ name, showError }: NameVerifyProps) {
    const passed = getNameVerifiedLevel(name); 
